...
class TempestWeatherStation extends sdk_1.ScryptedDeviceBase {
    constructor(nativeId) {
        super(nativeId);
        ...
        this.temperatureUnit = sdk_1.TemperatureUnit.C; // Default to Celsius
        this.updateStatus();
    ...
    async updateStatus() {
        ...
        try {
            const response = await axios_1.default.get(`https://swd.weatherflow.com/swd/rest/observations/station/${stationId}?token=${accessToken}`);
            ...
            this.onDeviceEvent(sdk_1.ScryptedInterface.Thermometer, this.temperature);
            this.onDeviceEvent(sdk_1.ScryptedInterface.HumiditySensor, this.humidity);
            this.onDeviceEvent(sdk_1.ScryptedInterface.BinarySensor, this.binaryState);
            this.onDeviceEvent(sdk_1.ScryptedInterface.Battery, this.batteryLevel);
...
exports["default"] = new TempestWeatherStation();
