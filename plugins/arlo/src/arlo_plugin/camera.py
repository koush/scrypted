...
from scrypted_sdk.types import Camera, VideoCamera, Intercom, MotionSensor, Battery, DeviceProvider, ScryptedMimeTypes
...
class ArloCameraSpeaker:

    async def startRTCSignalingSession(session):
        pass