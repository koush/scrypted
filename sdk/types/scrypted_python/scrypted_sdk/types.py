...
class ChatCompletionCreateParamsNonStreaming(TypedDict):
    ...
    audio: ChatCompletionAudioParam  # Parameters for audio output. Required when audio output is requested with  . [Learn more](https://platform.openai.com/docs/guides/audio).
    ...
    modalities: list[Any | Any]  # Output types that you would like the model to generate. Most models are capable of generating text, which is the default:     The   model can also be used to [generate audio](https://platform.openai.com/docs/guides/audio). To request that this model generate both text and audio responses, you can use:  
    ...
    n: float  # How many chat completion choices to generate for each input message. Note that you will be charged based on the number of generated tokens across all of the choices. Keep   as   to minimize costs.
