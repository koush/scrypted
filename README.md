...
4. Install the Unifi, HikVision, ONVIF, or Amcrest camera plugin
   ...
   * If there's no plugin for your camera but it supports motion alerts using mail, use the SMTP plugin.
   * If there's no plugin or mail support for your camera, you can install the RTSP and generic RTSP and the OpenCV motion detector plugin. This will use the processing power on your server to detect camera motion.
