...
export class EventRegistry {
    ...
    notify(id: string|undefined, state: { [property: string]: SystemDeviceState }|undefined, eventInterface: string, property: string|undefined, value: any, changed?: boolean): boolean {
        ...
        const eventDetails = {
            changed,
            eventInterface,
            eventTime: state?.[property]?.lastEventTime,
            property,
        };
